...
Scene::Scene(int width, int height, int depth, const string & filename, const vector<Object> & objects)
: width_(width), height_(height), depth_(depth), filename_(filename), objects_(objects)
{}

Scene::Scene(int width, int height, int depth, const string & filename, vector<Object> && objects)
: width_(width), height_(height), depth_(depth), filename_(filename), objects_(move(objects))
{}
...
ostream & ARTOS::operator<<(ostream & os, const Scene & scene)
{
...
istream & ARTOS::operator>>(istream & is, Scene & scene)
{
