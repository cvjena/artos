...
#ifndef ARTOS_SCENE_H
#define ARTOS_SCENE_H
...
public:
    ...
    */
    ...
    /**
    * @return Returns the list of objects present in the scene.
    */
    ...
    */
    ...
    /**
    * @return Returns true if the scene is empty. An empty scene has an empty image and no object.
    */
    bool empty() const;
