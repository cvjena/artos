...
#ifndef ARTOS_RECTANGLE_H
#define ARTOS_RECTANGLE_H
...
public:
    ...
    */
    ...
    /**
    * @return Returns the x-coordinate of the rectangle.
    */
    int x() const;
    ...
    */
    ...
    /**
    * @return Returns the y-coordinate of the rectangle.
    */
    int y() const;
    ...
    */
    ...
    /**
    * @return Returns true if the rectangle is empty. An empty rectangle has no area.
    */
    bool empty() const;
