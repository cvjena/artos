...
#ifndef ARTOS_OBJECT_H
#define ARTOS_OBJECT_H
...
public:
    ...
    */
    ...
    /**
    * @return Returns the name (label) of the object.
    */
    Name name() const;
    ...
    */
    ...
    /**
    * @return Returns the string representation of the name (label) of the object.
    */
    ...
    */
    ...
    /**
    * @return Returns the pose (view) of the object.
    */
    Pose pose() const;
    ...
    */
    ...
    /**
    * @return Returns whether the object is annotated as being truncated.
    */
    bool truncated() const;
    
    /**
    * @return Annotates the object as being truncated.
    */
    void setTruncated(bool truncated);
    
    /**
    * @return Returns whether the object is annotated as being difficult.
    */
